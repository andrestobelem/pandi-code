...
export const meta = {
  ...
  description: 'Scout a work-list, fan out independent reviewers, synthesize as judge with evidence and partial-failure notes (fan-out-and-synthesize)',
  phases: [
    { title: 'Scout' },
    { title: 'Review' },
    { title: 'Synthesize' },
...
if (candidates.length < allCandidates.length) {
  log('candidate cap applied ' + JSON.stringify({
...
log('fan-out complete ' + JSON.stringify({
