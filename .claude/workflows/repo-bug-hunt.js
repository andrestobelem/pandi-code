...
export const meta = {
  name: 'repo-bug-hunt',
  description: 'Scout code files, fan out per-file bug reviewers, synthesize prioritized findings with citations (bug-hunt-repo-audit)',
  phases: [
    { title: 'Scout' },
    { title: 'Review' },
    { title: 'Synthesis' },
...
if (files.length < allFiles.length) {
  log('candidate file cap applied ' + JSON.stringify({
...
log('bug-hunt fan-out complete ' + JSON.stringify({ total: reviews.length, completed: completedReviews.length, failed }));
