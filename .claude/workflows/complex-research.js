...
export const meta = {
  ...
  description: 'Independent research angles with web search, synthesized as judge with citations and coverage notes (complex-research)',
  phases: [
    { title: 'Research' },
    { title: 'Synthesis' },
  ],
...
const rawAngles = (Array.isArray(input?.angles) && input.angles.length) ? input.angles : [
...
log('research fan-out complete ' + JSON.stringify({ total: research.length, completed: completedResearch.length, failed }));
