...
Attribution:
- Internal: `Fixed foo ([#123](https://github.com/andrestobelem/pandi-code/issues/123))`
- External: `Added bar ([#456](https://github.com/andrestobelem/pandi-code/pull/456) by [@user](https://github.com/user))`
