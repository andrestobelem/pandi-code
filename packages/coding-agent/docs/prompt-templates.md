> Pandi can create prompt templates. Ask it to build one for your workflow.
...
Pandi loads prompt templates from:

- Global: `~/.pandi/agent/prompts/*.md`
- Project: `.pandi/prompts/*.md` (only after the project is trusted)
