...
// ============================================================================
// OAuth API key resolution from ~/.pandi/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".pandi", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.pandi/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.pandi/agent/auth.json
 */
...
export const PI_AGENT_DIR = join(homedir(), ".pandi", "agent");

/**
 * Get an AuthStorage instance backed by ~/.pandi/agent/auth.json
